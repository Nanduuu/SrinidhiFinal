...
import { getStaffInvoiceRates ,updateInvoiceRates } from './Actions';
...
const mapStateToProps = (state)=>{
  return{
      staffInvoiceRates : state.Reducer.staffInvoiceRates,
  }
}

const mapDispatchToProps =(dispatch)=>{
  return{
    getStaffInvoiceRates : ()=>{
      dispatch(getStaffInvoiceRates());
    },
...
class AddStaffCharges extends React.Component{
	constructor(props){
		super(props);
    this.state = {
      shift_type : "",
  ...
  componentDidMount(){
     ...
     this.props.getStaffInvoiceRates();
...
export default connect( mapStateToProps,mapDispatchToProps) (AddStaffCharges);